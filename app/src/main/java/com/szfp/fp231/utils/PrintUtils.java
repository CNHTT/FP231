...
public class PrintUtils {
	...
	public static void printBarCode(PrinterInstance mPrinter) {
		...
		barcode = new Barcode(PrinterConstants.BarcodeType.UPC_A, 2, 150, 2, "123456789012");
		...
		barcode = new Barcode(PrinterConstants.BarcodeType.JAN13, 2, 150, 2, "123456789012");
		mPrinter.printBarCode(barcode);

		// JAN8(EAN8) 1234567
		mPrinter.printText("JAN8(EAN8)\n");
		barcode = new Barcode(PrinterConstants.BarcodeType.JAN8, 2, 150, 2, "1234567");
		mPrinter.printBarCode(barcode);

		// "CODE39"
		mPrinter.printText("CODE39\n");
		barcode = new Barcode(PrinterConstants.BarcodeType.CODE39, 2, 150, 2, "123456");
		mPrinter.printBarCode(barcode);

		// ITF
		mPrinter.printText("ITF\n");
		barcode = new Barcode(PrinterConstants.BarcodeType.ITF, 2, 150, 2, "123456");
		mPrinter.printBarCode(barcode);

		// CODABAR
		mPrinter.printText("CODABAR\n");
		barcode = new Barcode(PrinterConstants.BarcodeType.CODABAR, 2, 150, 2, "123456");
		mPrinter.printBarCode(barcode);
		// CODE93
		mPrinter.printText("CODE93\n");
		barcode = new Barcode(PrinterConstants.BarcodeType.CODE93, 2, 150, 2, "123456");
		mPrinter.printBarCode(barcode);

		// Code128
		mPrinter.printText("CODE128\n");
		barcode = new Barcode(PrinterConstants.BarcodeType.CODE128, 2, 150, 2, "No.123456");
		mPrinter.printBarCode(barcode);

		// ========
		// "PDF417"
		mPrinter.printText("PDF417\n");
		barcode = new Barcode(PrinterConstants.BarcodeType.PDF417, 2, 3, 6, "No.123456");
		mPrinter.printBarCode(barcode);
		// "DATAMATRIX"
		mPrinter.printText("DATAMATRIX\n");
		barcode = new Barcode(PrinterConstants.BarcodeType.DATAMATRIX, 2, 3, 6, "No.123456");
		mPrinter.printBarCode(barcode);
		// "QRCODE"
		mPrinter.printText("QRCODE\n");
		barcode = new Barcode(PrinterConstants.BarcodeType.QRCODE, 2, 3, 6, "No.123456");
		mPrinter.printBarCode(barcode);
